...
bool isValidPan(
  ...
  if (inputString != null && inputString.isNotEmpty) {
    if (inputString.length > 10 || inputString.length < 6) return false;
...
bool isValidVehicle(
  ...
  if (inputString != null && inputString.isNotEmpty) {
    ...
    const pattern2 = r"^[a-zA-z]{2}\s[0-9]{2}\s[0-9]{4}$";

    final regExp1 = RegExp(pattern1);
    final regExp2 = RegExp(pattern2);

    isInputStringValid =
        regExp1.hasMatch(inputString) || regExp2.hasMatch(inputString);
  }
